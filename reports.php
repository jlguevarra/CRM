...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // NOTE: You need to define generateReportData() and calculateStats() in functions.php
...
<head>
    ...
    <style>
        /* Styles for the Reports page content */
        .header {
        ...
        .filters {
            ...
            box-shadow: var(--box-shadow); margin-bottom: 25px; display: grid;
...
<body>
    ...
    <div class="main-content">
        ...
        <table class="data-table">
            ...
            <tbody>
                <tr>
                    <td colspan="4" style="text-align: center;">Apply filters to generate a report.</td>
                </tr>
            </tbody>
        </table>
